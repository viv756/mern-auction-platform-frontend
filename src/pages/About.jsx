...
const About = () => {
  ...
  return (
    <section className="w-full ml-0 m-0 h-fit px-5 pt-20 lg:pl-[320px] gap-7 flex flex-col min-h-screen py-4 justify-center">
      <div>
        <H1 content={" About Us"} color={`#d6482b`} />
      ...
      <div>
        ...
        <p className="text-xl text-stone-600">
          At PrimeBid, our mission is to revolutionize the way people buy and sell items online. We
      ...
      <div>
        ...
        <p className="text-xl text-stone-600">
          Founded by Vivek, PrimeBid was born out of a passion for connecting people with unique and
